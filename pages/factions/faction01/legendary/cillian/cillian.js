      ...
      spells: [
        {
          ...
          description: `
			...
			Chaque frappe possede 35% de chances de voler 30% du Compteur de Tour actuel de la cible.
          `,
          damage: "1.6*ATQ",
          levelInfo: [
            "Dégâts +10%",
        ...
        },
        {
          ...
          description: `
			...
			Possede 85% de chances de placer un debuff ${DEBUFFS.LOCK_ACTIVE} pendant 2 tours.
          `,
          damage: "4.3*ATQ",
          cooldown: 5,
          levelInfo: [
        ...
        },
        {
          ...
          description: `
			...
			Reinitialise le temps de recharge de cette Competence si la cible est tuee.
          `,
          damage: "5.5*ATQ",
          cooldown: 5,
          levelInfo: [
        ...
        },
        {
          ...
          description: `
			...
			${BUFFS.CDAM} de 30%,
			${BUFFS.CRATE} de 30%,
			${BUFFS.STRENGTHEN} de 25%,
			${BUFFS.BLOCK_DAMAGE} ou
			${BUFFS.PRE} de 50%.
          `,
		  isPassive: true,
        },
