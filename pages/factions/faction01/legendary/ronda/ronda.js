      ...
      spells: [
        {
          ...
          name: "Deluge de flammes",
          description: `
            Attaque 3 fois un ennemi. Place une frappe supplémentaire si la cible possède moins de 50 % de PV après la troisième frappe.
          `,
          damage: "1.2*ATQ",
          levelInfo: [
            "Dégâts +5%",
        ...
        },
        {
          ...
          description: `
            Attaque 3 fois un ennemi. Ignorera les buffs ${BUFFS.SHIELD} et 30 % de la DÉF de la cible.<br><br>
			Place un débuff ${DEBUFFS.LOCK_PASSIF} pendant 2 tours avant d'attaquer. Il est impossible de résister à ce débuff.<br><br>
        ...
        },
        {
          ...
          description: `
            Attaque 2 fois tous les ennemis. Les dégâts augmentent de 30 % si cette Championne a plus de 50 % de PV.<br><br>${PASSIVE}
			Immunisée contre les effets de réduction du Compteur de Tour utilisés par les ennemis quand cette compétence n’est pas en temps de recharge.<br><br>
        ...
        },
        {
          ...
          name: "De ton cote [P]",
          description: `
            Possède 15 % de chances de rejoindre une attaque dès qu'un allié attaque un ennemi. Cette Championne attaquera avec sa compétence par défaut.<br><br>
