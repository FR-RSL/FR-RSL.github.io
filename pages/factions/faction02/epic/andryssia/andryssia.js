const championData = {
  ...
  spells: [
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. Possède 75% de chances de réduire de 2 tours la durée de tous les buffs sur les ennemis.${RETURN}${RETURN}
...
Augmente d'1 tour la durée de tous les buffs ${BUFFS.DEF} sur les alliés.`,
        ...
        },
        {
          ...
          name: "Coeur-fort [P]",
          description: `Au début de chaque tour, place sur l'allié ayant le moins de PV MAX un buff ${BUFFS.ALLY_PROTECT} de 50% pendant 2 tours. Ne sera pas placé sur cette Championne.${RETURN}${RETURN}
