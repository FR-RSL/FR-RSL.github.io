const championData = {
  ...
  spells: [
        ...
        },
        {
          ...
          name: "Entrave",
          description: `Attaque tous les ennemis. Avant d'attaquer, possède 75 % de chances de réduire d'1 tour la durée de tous les buffs ennemis.${RETURN}${RETURN}
...
Possède 75 % de chances de placer un débuff ${DEBUFFS.SPD} de 30 % pendant 2 tours.`,
        ...
        },
        {
          ...
          description: `Place un buff ${BUFFS.ALLY_PROTECT} de 50 % sur tous les alliés sauf ce Champion pendant 2 tours et place un buff ${BUFFS.DEF} de 60 % sur tous les alliés pendant 2 tours.${RETURN}${RETURN}
...
Place également un buff ${BUFFS.COUNTER} sur ce Champion pendant 2 tours. Ensuite, place un buff ${BUFFS.SHIELD} sur ce Champion pendant 2 tours. La valeur du ${BUFFS.SHIELD} est proportionnelle à la DÉF de ce Champion.`,
        ...
        },
        {
          ...
          description: `Dès que ce Champion se fait attaquer, il se soigne de 1 % par tranche de 500 DÉF qu'il possède.${RETURN}${RETURN}
