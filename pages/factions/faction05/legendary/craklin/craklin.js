...
Chaque frappe a 80 % de chances de placer un débuff ${DEBUFFS.HEALS} de 100 % pendant 2 tours. 
...
Possède 75 % de chances de placer un débuff ${DEBUFFS.PRE} de 50 % et un débuff ${DEBUFFS.WEAKEN} de 25 % pendant 2 tours. 
...
Augmente d'1 tour la durée de tous les buffs ${BUFFS.HEALS} sur tous les alliés.`,
        ...
        },
        {
          ...
          description: `Rétablit 50 % des PV MAX détruits de chaque allié. 
