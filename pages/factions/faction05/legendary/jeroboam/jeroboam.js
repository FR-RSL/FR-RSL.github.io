...
Possède 35 % de chances de réduire d'1 tour le temps de recharge d'une compétence aléatoire d'un allié. 
...
Soigne tous les alliés à hauteur de 15 % des PV MAX de ce Champion. Soigne également chaque allié de 2 % supplémentaires pour chaque débuff retiré par cette compétence. 
...
Place sur tous les alliés un buff ${BUFFS.SHIELD} équivalent à 15 % des PV MAX de ce Champion pendant 2 tours.`,
        ...
        },
        {
          ...
          description: `Possède 75 % de chances d'augmenter d'1 tour la durée de tous les débuffs ennemis. Possède également 75 % de chances d'augmenter d'1 tour la durée de tous les buffs alliés. 
...
Les effets de réduction du Compteur de Tour utilisés contre ce Champion par les ennemis sont réduits de 50 %. 
