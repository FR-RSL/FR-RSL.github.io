...
Place également un buff ${BUFFS.REFLECT_DAM} de 30 % sur tous les alliés pendant 2 tours, puis soigne ce Champion de 50 % de ses PV MAX.`,
        ...
        },
        {
          ...
          description: `Dès qu'un allié sous buff ${BUFFS.REFLECT_DAM} est attaqué, place un débuff ${DEBUFFS.LEECH} sur l'assaillant pendant 1 tour.

Renvoie sur l'assaillant 50 % des dégâts reçus par ce Champion. 
