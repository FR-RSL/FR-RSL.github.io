  ...
  spells: [
        {
          ...
          name: "Tyran de meute",
          description: `Attaque tous les ennemis. Cette attaque inflige à chaque cible individuelle des dégâts sur cible unique plutôt que des dégâts de zone. Ignorera également tous les buffs et effets ${BUFFS.REFLECT_DAM}, les buffs et effets ${BUFFS.ALLY_PROTECT}, et les débuffs ${DEBUFFS.PAIN_LINK}.${RETURN}${RETURN}
