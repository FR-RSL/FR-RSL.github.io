const championData = {
  type: "PV",
        ...
        },
        {
          ...
          description: `
            Attaque tous les ennemis. Possède 75% de chances de placer un débuff de${RETURN}
        ...
        },
        {
          ...
          description: `
            Place, pendant 2 tours, un buff de <span class='gbt'>Protection d'Allié</span> de 50% sur tous les${RETURN}
        ...
        },
        {
          ...
          description: `           
		  Réduit de 10% les dégats infligés par les ennemis affligés de débuffs${RETURN}
