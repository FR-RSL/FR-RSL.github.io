      ...
      spells: [
        {
			...
			name: "Sceau Abyssal",
			description: `Attaque un ennemi. Place un débuff ${DEBUFFS.BURN} sur la cible pendant 2 tours si elle se trouve sous débuff ${DEBUFFS.TRUE_FEAR} ou ${DEBUFFS.ATK}.
...
Place sur ce Champion un buff ${BUFFS.SHIELD} égal à 10 % de ses PV MAX pendant 2 tours.`,
        ...
        },
        {
        	...
        	description: `Reçoit 20 % de dégâts en moins de la part des Champions des Factions des Grands Seigneurs, des Hauts Elfes et de l'Ordre Sacré. 

S'il y a 2 Champions Rejetons Démoniaques ou plus dans l'équipe aux côtés de ce Champion, augmente de 20 % les DÉG C. de tous les Champions Rejetons Démoniaques de l'équipe. 
