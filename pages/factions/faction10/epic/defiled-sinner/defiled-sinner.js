  ...
  spells: [
        {
          ...
          description: `Attaque un ennemi. Avant d'attaquer, possède 50 % de chances de placer un débuff de ${DEBUFFS.DEF} de 60 % pendant 2 tours.${RETURN}${RETURN}

Si 5 ennemis ou plus sont vivants, réalise l'attaque suivante à la place :${RETURN}
