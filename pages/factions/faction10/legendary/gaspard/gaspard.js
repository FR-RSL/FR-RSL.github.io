const championData = {
  ...
  spells: [
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. A 75 % de chances de placer un débuff ${DEBUFFS.PROVOKE} pendant 1 tour. 
...
Place un buff ${BUFFS.DEF} de 60 % et un buff ${BUFFS.SHIELD} sur tous les alliés pendant 2 tours. La valeur du ${BUFFS.SHIELD} est proportionnelle à la DÉF de ce Champion.`,
        ...
        },
        {
          ...
          name: "Tu es accusé",
          description: `Attaque un ennemi. Ignorera les buffs ${BUFFS.LIFE_BARRIER}, ${BUFFS.POISON_CLOUD}, ${BUFFS.SHIELD} et ${BUFFS.BLOCK_DAMAGE}, ainsi que 25 % de la DÉF de la cible. 

Si la cible a été tuée par cette compétence, ranime un allié mort aléatoire avec 50 % de PV et 50 % de Compteur de Tour. Cette réanimation ignorera les débuffs ${DEBUFFS.BLOCK_REA}. 
...
Place un débuff ${DEBUFFS.BLOCK_REA} sur les cibles tuées par cette compétence.`,
        ...
        },
        {
          ...
          description: `Dès qu'un ennemi est ranimé, active instantanément la compétence Tu es accusé contre cet ennemi. Si plusieurs ennemis sont ranimés, la cible initiale de la réanimation sera ciblée par la compétence Tu es accusé. Ne placera pas la compétence Tu es accusé en temps de recharge. 

A 50 % de chances d'activer la compétence Tu es accusé sur un ennemi dès qu'un allié est tué. Se produit une fois par tour. 

Active instantanément la compétence Tu es accusé contre une Tête d'Hydre dès qu'un allié est consommé par cette Tête. Ne placera pas la compétence Tu es accusé en temps de recharge.
