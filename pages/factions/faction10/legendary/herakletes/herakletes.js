...
Place un débuff ${DEBUFFS.TRUE_FEAR} sur la cible pendant 1 tour. Il est impossible de résister à ce débuff et de le bloquer si ce Champion est mort. 
...
Si ce Champion est mort, soigne également tous les alliés à hauteur de 20 % de leurs PV MAX.`,
        ...
        },
        {
          ...
          description: `Attaque un ennemi. Ignorera 100 % de la DÉF de la cible. 
...
Si la cible a été tuée, ranime un allié mort aléatoire avec 50 % de PV et 50 % de Compteur de Tour. Si la cible a été tuée et qu'il n'y a pas d'allié mort, réinitialise au lieu de ça le temps de recharge de la compétence.`,
        ...
        },
        {
          ...
          name: "Pour Valdemar !",
          description: `Attaque tous les ennemis. Détruit les PV MAX de tous les ennemis de 10 %. 
...
(ne s'applique qu'à la Faction des Morts-vivants)
