...
Ignorera 33% de la DÉF de la cible. Ignorera au lieu de cela 99% de la DÉF de la cible, ainsi que les buffs ${BUFFS.STONE_SKIN} et ${BUFFS.BLOCK_DAMAGE}, si cette compétence est utilisée lors d'un Tour dont le nombre est divisible par 3.${RETURN}${RETURN}
...
Si la cible est tuée, augmente de 3 tours les temps de recharge de toutes les compétences ennemies. Il est impossible de résister à cet effet si cette compétence est utilisée lors d'un Tour dont le nombre est divisible par 3.`,
        ...
        },
        {
          ...
          name: "Cri de carnage",
          description: `Attaque un ennemi. Avant d'attaquer, retire tous les buffs de tous les ennemis. Les ennemis qui ont un nombre de buffs divisible par 3 ne peuvent pas résister à cet effet. Attaquera tous les ennemis restants qui ont moins de 66% de PV.${RETURN}${RETURN}
...
Accorde un Tour supplémentaire si cette Championne bénéficie d'un nombre de buffs divisible par 3.`,
        ...
        },
        {
          ...
          name: "Dis son nom [P]",
          description: `Chaque frappe suivante de cette Championne inflige 33% de dégâts supplémentaires (s'accumule jusqu'à 99%). Se réinitialise lorsque le bonus de dégâts de 99% est appliqué.${RETURN}${RETURN}

Chaque frappe suivante que cette Championne reçoit inflige 33% de dégâts en moins (11% contre les Boss). S'accumule jusqu'à 3 fois. Se réinitialise lorsque la réduction des dégâts est appliquée pour la troisième fois.${RETURN}${RETURN}
