    ...
    spells: [
        {
          ...
          description: `Attaque un ennemi. Place un débuff ${DEBUFFS.DEF} de 60 % pendant 2 tours.${RETURN}${RETURN}
...
Place également un buff ${BUFFS.PERFECT_VEIL} sur ce Champion pendant 1 tour.`,
        ...
        },
        {
          ...
          name: "Sombres dards",
          description: `Attaque tous les ennemis. Avant d'attaquer, place un buff ${BUFFS.ATK} de 50 % sur tous les alliés pendant 2 tours.${RETURN}${RETURN}

Ignorera 25 % de la DÉF de la cible si elle ne se trouve pas sous débuff ${DEBUFFS.BURN}. Ignorera 50 % de la DÉF de la cible si elle se trouve sous débuff ${DEBUFFS.BURN}.${RETURN}${RETURN}
...
Augmente ensuite d'1 tour la durée de tous les débuffs des ennemis.`,
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. Les dégâts augmentent de 25 % contre les cibles qui sont affligées de débuffs.${RETURN}${RETURN}

Active instantanément un déclenchement de tous les débuffs ${DEBUFFS.BURN} sur tous les ennemis.${RETURN}${RETURN}
...
Si un ennemi ne se trouve pas sous débuff ${DEBUFFS.BURN}, lui inflige un débuff ${DEBUFFS.BURN} pendant 2 tours.`,
        ...
        },
        {
          ...
          name: "Brûle-chair [P]",
          description: `Chaque fois que ce Champion place un débuff ${DEBUFFS.BURN}, réduit la DÉF de la cible de 3 % (s'accumule jusqu'à 30 %).${RETURN}${RETURN}

Pour chaque débuff ${DEBUFFS.BURN} sur l'équipe ennemie, augmente les DÉG. C. de ce Champion de 10 % (s'accumule jusqu'à 100 %).${RETURN}${RETURN}
  ...
  form2: {
    ...
    spells: [
        ...
        },
        {
          ...
          name: "Cocon putride",
          description: `Attaque tous les ennemis. Place un débuff ${DEBUFFS.STUN} sur tous les ennemis pendant 1 tour.${RETURN}${RETURN}
...
Place également deux buffs ${BUFFS.HEALS} de 15 % sur tous les alliés pendant 2 tours.`,
        ...
        },
        {
          ...
          description: `Place un débuff ${DEBUFFS.PROVOKE} sur tous les ennemis pendant 1 tour.${RETURN}${RETURN}
...
Place également un buff ${BUFFS.STRENGTHEN} de 25 % et un buff ${BUFFS.DEF} de 60 % sur tous les alliés pendant 2 tours.`,
        ...
        },
        {
          ...
          name: "Entomophobie [P]",
          description: `Lorsque le Champion est attaqué, a 100 % de chances de placer un débuff ${DEBUFFS.WEAKEN} de 25 % et 40 % de chances de placer un débuff ${DEBUFFS.STUN} sur l'assaillant pendant 1 tour.${RETURN}${RETURN}
