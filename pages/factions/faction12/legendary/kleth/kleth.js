...
Possède 80 % de chances de placer un débuff ${DEBUFFS.WEAKEN} de 25 % pendant 2 tours. Il est impossible de résister à ce débuff si la cible a attaqué ce Champion avant ce tour.`,
        ...
        },
        {
          ...
          description: `Les niveaux de PV de tous les alliés seront amenés au niveau de l'allié qui a le plus de PV. Les niveaux de Compteur de Tour de tous les alliés seront amenés au niveau de l'allié qui a le Compteur de Tour le plus élevé. 
...
Ensuite, place un buff ${BUFFS.TAUNT} sur ce Champion pendant 2 tours.`,
        ...
        },
        {
          ...
          description: `Attaque un ennemi. Avant d'attaquer, transfère tous les débuffs de ce Champion sur la cible et soigne ce Champion de 10 % de ses PV MAX. Soigne ce Champion de 10 % supplémentaires de ses PV MAX pour chaque débuff transféré. 
...
(ne s'applique qu'à la Faction des Revenants Chevaliers)
