  ...
  spells: [
        {
          ...
          description: `Attaque un ennemi. A 35 % de chances de placer un débuff ${DEBUFFS.STUN} pendant 1 tour.
...
Ignorera 30 % de la DÉF de la cible si la cible est affligée d'un débuff ${DEBUFFS.PROVOKE}.`,
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. 75 % de chances de retirer tous les buffs.
...
A également 75 % de chances de placer un débuff ${DEBUFFS.ATK} de 50 % et un débuff ${DEBUFFS.HEX} pendant 2 tours.`,
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. Augmente d'1 tour la durée de tous les débuffs sur chaque cible, puis place un débuff ${DEBUFFS.PROVOKE}sur tous les ennemis pendant 1 tour. 
...
Place un buff ${BUFFS.SHIELD} sur tous les alliés pendant 2 tours, égal à 30 % des dégâts infligés, ainsi qu'un buff ${BUFFS.COUNTER} sur ce Champion pendant 2 tours. Les dégâts augmentent de 10 % pour chaque débuff dont est affligée la cible.`,
        ...
        },
        {
          ...
          description: `Ignorera 30 % de la RÉS d'une cible si la DÉF de la cible est inférieure à celle de ce Champion.

Les alliés infligent 25 % de dégâts en plus aux cibles sous débuff ${DEBUFFS.PROVOKE} placé par ce Champion.
