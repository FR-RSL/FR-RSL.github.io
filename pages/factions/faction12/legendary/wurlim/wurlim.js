  ...
  spells: [
        {
          ...
          name: "Vents d'Hiver",
          description: `Attaque un ennemi. A 30 % de chances de placer un débuff ${DEBUFFS.GEL} pendant 1 tour. Il est impossible de résister à ce débuff.
...
Place un buff ${BUFFS.PERFECT_VEIL} pendant 2 tours sur l'allié ayant le moins de PV.`,
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. A 70 % de chances de placer un débuff ${DEBUFFS.ATK} de 50 % et un débuff ${DEBUFFS.PRE} de 50 % pendant 2 tours. Il est impossible de résister à ces débuffs.
...
Place également un buff ${BUFFS.CDAM} de 30 % sur tous les alliés pendant 2 tours.`,
        ...
        },
        {
          ...
          description: `Place un buff ${BUFFS.STRENGTHEN} de 25 % et un buff ${BUFFS.DEF} de 60 % sur tous les alliés pendant 2 tours.
