...
Retire les buffs ${BUFFS.STONE_SKIN} et les remplace par un débuff ${DEBUFFS.TRUE_FEAR}. Les buffs ${BUFFS.BLOCK_DEBUFFS} seront remplacés par des débuffs ${DEBUFFS.BLOCK_BUFFS}.${RETURN}${RETURN}
...
Il est impossible de résister à ces effets si les ennemis sont affligés de piles de ${DEBUFFS.NECROSIS}.`,
        ...
        },
        {
          ...
          name: "Métamorphe",
          description: `Fait passer ce Champion à sa Forme alternative.${RETURN}${RETURN}
...
Accorde ensuite un Tour supplémentaire.`,
        ...
        },
        {
          ...
          name: "Métamorphe",
          description: `Fait passer ce Champion à sa Forme de base.${RETURN}${RETURN}
...
Si plusieurs Champions de l'équipe disposent de cette Compétence, une seule sera activée. Cette compétence ne s'activera pas sur les copies en double de ce Champion si ce Champion spécifique est mort.${RETURN}${RETURN}
