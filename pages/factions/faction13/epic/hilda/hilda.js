...
Les dégâts infligés par cette compétence augmentent de 10% pour chaque débuff sur la cible (s'accumule jusqu'à 100%).${RETURN}${RETURN}
...
A 40% de chances de placer un débuff ${DEBUFFS.STUN} pendant 1 tour.`,
        ...
        },
        {
          ...
          description: `Les alliés infligent 15% de dégâts en plus aux cibles affligées d'un débuff ${DEBUFFS.HEALS} ou ${DEBUFFS.STUN} placé par cette Championne.${RETURN}${RETURN}
