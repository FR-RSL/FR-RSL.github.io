...
Active instantanément cette Compétence dès qu'un ennemi sous débuff ${DEBUFFS.GEL} et ${DEBUFFS.BURN} subit des dégâts d'un débuff ${DEBUFFS.BURN}.`,
        ...
        },
        {
          ...
          description: `Retire tous les buffs d'un ennemi ciblé, puis attaque 2 fois la cible. Sinon, vole tous les buffs si la cible se trouve sous débuff ${DEBUFFS.GEL}.${RETURN}${RETURN}
