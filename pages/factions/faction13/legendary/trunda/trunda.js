  ...
  type: "Attaque",
      spells: [
        ...
        },
        {
          ...
          description: `Attaque un ennemi, puis attaque tous les autres ennemis avec une seconde frappe, infligeant 60 % des dégâts infligés lors de la première frappe et ignorant 50 % de la DÉF de la cible.${RETURN}${RETURN}
...
Seule la seconde frappe de la compétence ignore 50 % de la DÉF de la cible. Cette seconde frappe est toujours un coup normal.`,
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. Possède 70 % de chances de placer un débuff ${DEBUFFS.STUN} pendant 1 tour.${RETURN}${RETURN}
...
Place également un débuff ${DEBUFFS.BURN} pendant 2 tours. Place une frappe supplémentaire sur les ennemis qui ne sont pas affligés de débuffs ${DEBUFFS.STUN}. Les deux frappes de cette compétence infligent 50 % de dégâts en plus à un bouclier ${BUFFS.STONE_SKIN}.`,
        ...
        },
        {
          ...
          description: `L'ATQ de cette Championne augmente de 10 % points pour chaque débuff ${DEBUFFS.STUN} ou ${DEBUFFS.BURN} que cette Championne place sur des ennemis (s'accumule jusqu'à 50 % par Manche).${RETURN}${RETURN}
