    ...
    spells: [
        {
          ...
          name: "Saignée rapide",
          description: `Attaque un ennemi. Possède 50 % de chances d'attaquer un autre ennemi s'il se trouve sous débuff ${DEBUFFS.LEECH}. 

Place également un buff ${BUFFS.PERFECT_VEIL} sur ce Champion pendant 1 tour.`,
          damage: "2.8*ATQ+0.1*HP",
          levelInfo: ["Dégâts +20%"],
          isPassive: false
        },
        {
          ...
          description: `Attaque 4 fois de façon aléatoire. Chaque frappe augmente l'ATQ et les PV de ce Champion de 5 % lorsqu'il se trouve sous sa Forme de base (s'accumule jusqu'à 100 %). Si une cible se trouve sous débuff ${DEBUFFS.LEECH}, l'ATQ et les PV de ce Champion sont au lieu de ça augmentés de 10 %. 

Les dégâts infligés par cette compétence augmentent de 15 % pour chaque débuff ${DEBUFFS.LEECH} placé sur l'équipe ennemie.`,
          damage: "1.5*ATQ+0.1*HP",
          cooldown: 3,
...
Place un débuff ${DEBUFFS.DEF} de 60 % et un débuff ${DEBUFFS.LEECH} pendant 2 tours. 

Place une frappe supplémentaire sur les ennemis sous 2 débuffs ou plus.`,
          damage: "3.5*ATQ+0.1*HP",
          cooldown: 3,
        ...
        },
        {
          ...
          description: `Remplit le Compteur de Tour de ce Champion de 5 % chaque fois qu'il attaque une cible sous débuff ${DEBUFFS.LEECH}. 
...
Soigne tous les alliés sauf ce Champion à hauteur de 10 % des dégâts infligés. La valeur du soin augmente de 5 % pour chaque débuff ${DEBUFFS.LEECH} dont est affligée l'équipe ennemie.`,
        ...
        },
        {
          ...
          description: `Attaque tous les ennemis. Place un débuff ${DEBUFFS.SPD} de 30 % et un débuff ${DEBUFFS.LEECH} pendant 2 tours. 

Accorde ensuite un Tour supplémentaire.`,
          damage: "0.27*HP+0.7*ATQ",
          cooldown: 4,
          levelInfo: ["Dégâts +20%", "Ignorer la RES +20%"],
          isPassive: false
        },
        ...
        },
        {
          ...
          description: `Double la quantité de soin reçue par ce Champion lorsqu'il attaque des ennemis sous débuff ${DEBUFFS.LEECH}. 
